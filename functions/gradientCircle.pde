...
void gradientCircle(float cX, float cY, float radius, float startAngle, float endAngle, float cStep, float noiseScale, int red, int green, int blue, float cVar, float noiseRStart, float noiseGStart, float noiseBStart) {
